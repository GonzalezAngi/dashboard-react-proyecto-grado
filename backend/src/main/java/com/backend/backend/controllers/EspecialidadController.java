...
public class EspecialidadController {
    ...
    @GetMapping("mas-solicitadas")
    public List<EspecialidadCount> obtenerEspecialidadesMasSolicitadas() {
        return especialidadService.obtenerEspecialidadesMasSolicitadas();
    }
